  ...
  const handlePayment = async (e) => {
    ...
    try {
      ...
      const options = {
        ...
        image:
          "https://res.cloudinary.com/theprakashkumar/image/upload/v1696482028/caffe/Coffee/favicon-96x96_x3irua.png",
        ...
        <>
          ...
          {selectedAddress && !isAddressContainerOpen && (
            <div className="selected-address-container">
              <div>
                <p className="heading heading--h6">{selectedAddress.name}</p>
                <p>
          ...
          {selectedAddress && !isAddressContainerOpen && (
            <div className="payment-container">
              <div>
                <p className="order-summery-text">Order Summary</p>
                <p>{`${cartData.length} ${
                  cartData.length > 1 ? "Items" : "Item"
                }`}</p>
              </div>

              <button className="btn" onClick={(e) => handlePayment(e)}>
