        ...
        <div className="filters__inputs">
          <div className="input-checkbox-wrapper">
            <input
              ...
              id="checkbox-dark"
              checked={state.categories.some((value) => value === "Dark Roast")}
            />
          ...
          <div className="input-checkbox-wrapper">
            ...
            />
            <label htmlFor="checkbox-medium-dark">Medium Dark Roast Only</label>
          </div>
          <div className="input-checkbox-wrapper">
            <input
              onChange={() => {
            ...
            />
            <label htmlFor="checkbox-medium">Medium Roast Only</label>
          </div>
          <div className="input-checkbox-wrapper">
            <input
              onChange={() => {
          ...
          <div className="input-checkbox-wrapper">
            ...
            />
            <label htmlFor="fast-delivery">Show Fast Delivery Only</label>
          </div>
        </div>
      ) : null}
    </div>
